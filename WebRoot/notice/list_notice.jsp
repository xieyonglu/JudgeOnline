...
<input type="hidden" name="actionURL" value="notice_pageNotice.action"/>
...
<form name="form1" method="post" action="">
  <table width="1100px" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">公告信息管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr bgcolor="#DEE5FA">
        <td colspan="16" align=center bgcolor="#DEE5FA" class=txlrow>
        	<!--设定：
	          <label>
				  <input type="radio" name="do" value="1" />删除 
			  </label>
	          <label></label>
          	-->
