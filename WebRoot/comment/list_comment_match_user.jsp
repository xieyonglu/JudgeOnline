...
<input type="hidden" name="actionURL" value="comment_pageComment.action?userId=${sessionScope.loginUser.userId}&type=match"/>
  ...
  <table width="1000px" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>比赛排行</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="10%" align=center class=txlrow>
	        	<a href="comment_findComment.action?action=user&matchId=${matchId}&userId=${sessionScope.loginUser.userId}">查看评论</a>
	        </td>
