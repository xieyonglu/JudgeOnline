...
<input type="hidden" name="actionURL" value="problem_pageProblem.action?action=run"/>
...
<form name="form1" method="post" action="">
  <table width="1500px" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">试题[运行]信息管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="10%" align=center class=txlrow>
	        	<a href="code_pageFindCode.action?action=admin&problemId=${problemId}">查看运行</a>
	        </td>
	        <td width="10%" align=center class=txlrow>
	        	<a href="code_pageFindCode.action?action=all&problemId=${problemId}&type=sort">本题排行</a>
	        </td>
	    </tr>
	  </s:iterator> 
