...
<input type="hidden" name="actionURL" value="comment_findComment.action?action=all&matchId=${match.matchId}"/>
	...
	<table border="0" width="900px" cellspacing="0px" cellpadding="0px">
		<s:iterator value="#list" status="st">
			<tr>
				...
				<td class="td_1">
					<!--<s:property value="#st.index+1"/>--><s:property value="floor"/>楼
...
<form action="comment_insertComment.action" method="post">
	<table border="1" width="900" height="300" cellspacing="0px" cellpadding="0px">
		<tr>
