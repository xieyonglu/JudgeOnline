...
<input type="hidden" name="actionURL" value="submit_pageSubmit.action?userId=${sessionScope.loginUser.userId}&state=1&action=user"/>
...
<form name="form1" method="post" action="">
  <table width="1050px" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">已经攻克--试题信息管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
