...
<input type="hidden" name="actionURL" value="match_pageMatch.action?action=all"/>
						...
						<tr>
							<td colspan="2">
								<span style="color:blue; font-size:15px;"><b>
									<a href="problem_pageMatchProblem.action?matchId=${matchId}&action=all">
