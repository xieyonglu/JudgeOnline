...
$(function(){
	...
	var str="code_pageFindCode.action?conditionA="+conditionA+"&conditionB="+conditionB+
			...
			"&action=all&problemId="+${problem.problemId}+"&matchId="+${match.matchId};
    ...
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">
        	<span style="color:red;"><b>${match.matchName}-${problem.title}</b></span>所有运行结果
        </th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="6%" align="center" class=txlHeaderBackgroundAlternate>语言</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="6%" align=center class=txlrow>${language}</td>
	        <td width="8%" align=center class=txlrow>${codeLength}</td>
