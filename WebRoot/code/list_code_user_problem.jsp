...
$(function(){
	...
	var str="code_pageFindCode.action?conditionA="+conditionA+"&conditionB="+conditionB+
			...
			"&action=user&problemId="+${problem.problemId}+"&userId="+${user.userId};
  ...
  <table width="1200" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="18%" align="center" class=txlHeaderBackgroundAlternate>题目</td>
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>结果</td>
        <td width="7%" align="center" class=txlHeaderBackgroundAlternate>时间</td>
        <td width="7%" align="center" class=txlHeaderBackgroundAlternate>内存</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="7%" align=center class=txlrow>${runtime}</td>
	        <td width="7%" align=center class=txlrow>${memory}</td>
