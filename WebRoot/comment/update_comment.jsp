...
<table border="0" cellspacing="3px" cellpadding="1px" width="1000px">
	<tr>
		<td><div style="text-align:left; margin-left:5px;">修改评论</div></td>
	</tr>
</table>
...
<div style="width:900px; background-color:b0c4de;">
	...
	<table border="1px solid black" cellspacing="0px" cellpadding="5px" width="100%">
		...
		<tr><td class="td_1">试题标题</td>
			<td class="td_1">${comment.problem.title}</td>
		</tr>
		<tr><td class="td_1" width="100px">发题者</td>
			<td class="td_1">${comment.problem.admin.userName}&nbsp;</td>
		</tr>
		...
		<tr><td>&nbsp;</td>
			<td class="td_1">
				...
				<input type="hidden" name="problemId" value="${comment.problem.problemId}"/>
