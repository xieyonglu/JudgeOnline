...
<body>
<input type="hidden" name="actionURL" value="comment_findComment.action?action=user&matchId=${match.matchId}&userId=${user.userId}"/>
...
<center>
<span style="color:red;"><b>${match.matchName}比赛讨论区</b></span>
[<a href="comment_findComment.action?matchId=${match.matchId}">发表评论</a>]<br/>
亲爱的,用户:${user.userName},这是你关于这场比赛的所有评论！
		...
		<table border="0" width="900px">
			<s:iterator value="#list" status="st">
				<tr>
					...
					<td class="td_1"><s:property value="floor"/>楼<!--<s:property value="#st.index+1"/>楼--></td>
					<td class="td_1">回复数:${replyCount}</td>
					<td class="td_1">
						<a href="comment_deleteComment.action?commentId=${commentId}">删除</a>
						<a href="comment_showComment.action?commentId=${commentId}&action=matchUpdate">修改</a>
					</td>
				</tr>
				<tr>
