...
<input type="hidden" name="actionURL" value="problem_pageProblem.action?action=admin&adminId=${admin.adminId}"/>
...
<form name="form1" method="post" action="">
  <table width="1500px" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">我的试题信息管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
