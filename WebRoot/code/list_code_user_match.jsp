...
$(function(){
	...
	var pageSize=document.getElementsByName("select").item(0).value;
		...
		var str="code_pageFindCode.action?conditionA="+conditionA+"&conditionB="+conditionB+
				...
				"&action=user&matchId="+${match.matchId}+"&userId="+${user.userId};
...
<input type="hidden" name="actionURL" value="code_pageCode.action?matchId=${match.matchId}&action=user&userId=${user.userId}"/>
...
<form name="form1" method="post" action="">
  <table width="1200" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">用户${user.userName}-所有运行结果信息-${match.matchName}</th>
      </tr>
      <tr bgcolor="#DEE5FA">
        <td colspan="16" align="center" class=txlrow>
			...
			-->
				...
				用户名:<input type="text" name="conditionB" value="${user.userName}" readonly/>
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="8%" align="center" class=txlHeaderBackgroundAlternate>结果</td>
        <td width="8%" align="center" class=txlHeaderBackgroundAlternate>时间</td>
        <td width="8%" align="center" class=txlHeaderBackgroundAlternate>内存</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="8%" align=center class=txlrow>${state}</td>
	        <td width="8%" align=center class=txlrow>${runtime}</td>
	        <td width="8%" align=center class=txlrow>${memory}</td>
