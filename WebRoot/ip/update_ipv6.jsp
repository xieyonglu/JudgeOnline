...
<table border="0" cellspacing="3px" cellpadding="1px" width="900px">
	<tr>
		<td><div style="text-align:left; margin-left:5px;">修改IPV6</div></td>
	</tr>
</table>
...
<div style="width:900px; background-color:b0c4de;">
	...
	<form action="ipAddress_updateIpAddress.action?action=ipv6" method="post" name="form1">
		<table border="1px solid black" cellspacing="0px" cellpadding="5px" width="100%">
			<tr><td class="td_1" width="100px">&nbsp;</td>
				<td class="td_1">修改IPV6</td>
			</tr>
			<tr><td class="td_1" width="100px">&nbsp;</td>
			...
			<tr><td class="td_1">&nbsp;</td>
				<td class="td_1">
					...
					<input type="submit" value="修改IPV6" class="button"/>
				</td>
			</tr>	
		</table>
	</form>
