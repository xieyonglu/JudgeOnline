    ...
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">
        	<span style="color:red;"><b>${match.matchName}</b></span>比赛试题信息[运行]管理
        </th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>本题排行</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="10%" align=center class=txlrow>
	        	<a href="code_pageFindCode.action?action=all&problemId=${problemId}&matchId=${match.matchId}&type=sort">本题排行</a>
	        </td>
	        <td width="10%" align=center class=txlrow>
