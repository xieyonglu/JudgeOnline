...
$(function(){
	...
	var pageSize=document.getElementsByName("select").item(0).value;
		...
		var str="code_pageFindCode.action?conditionA="+conditionA+"&conditionB="+conditionB+
				...
				"&action=admin&problemId="+${problem.problemId};
...
<input type="hidden" name="actionURL" value="code_pageCode.action?action=user&userId=${user.userId}"/>
    ...
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">
        	<span style="color:red;"><b>${problem.title}</b></span>的所有运行结果信息[管理员界面]
        </th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="7%" align="center" class=txlHeaderBackgroundAlternate>结果</td>
        ...
        <td width="6%" align="center" class=txlHeaderBackgroundAlternate>代码长度</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="7%" align=center class=txlrow>${state}</td>
	        ...
	        <td width="6%" align=center class=txlrow>${codeLength}</td>
