...
<script type="text/javascript" src="${pageContext.request.contextPath}/ubbeditor/ubbeditor/ubbEditor.js"></script>
...
<table border="0" cellspacing="3px" cellpadding="1px" width="1000px">
	<tr>
		<td><div style="text-align:left; margin-left:5px;">添加试题</div></td>
	</tr>
</table>
...
<div style="width:900px; background-color:b0c4de;">
	<form action="problem_insertProblem.action" method="post" name="form1">
	<table border="1px solid black" cellspacing="0px" cellpadding="5px" width="100%">
		...
		<tr><td class="td_1">时间限制</td>
			<td class="td_1">
				<input type="text" name="problem.timeLimit" value="${problem.timeLimit}" style="width:150px; height:20px;"/>&nbsp;(MS)
				<s:fielderror cssClass="formFieldError"><s:param>problem.timeLimit</s:param></s:fielderror>
			</td>
		</tr>
		<tr><td class="td_1">内存限制</td>
			<td class="td_1">
				<input type="text" name="problem.memoryLimit" value="${problem.memoryLimit}" style="width:150px; height:20px;"/>&nbsp;(KB)
