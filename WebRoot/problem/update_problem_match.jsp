...
<table border="0" cellspacing="3px" cellpadding="1px" width="1000px">
	<tr>
		<td><div style="text-align:left; margin-left:5px;">修改比赛试题</div></td>
	</tr>
</table>
...
<div style="width:900px; background-color:b0c4de;">
	<form action="problem_updateMatchProblem.action" method="post" name="form1">
	<table border="1px solid black" cellspacing="0px" cellpadding="5px" width="100%">
		<tr><td class="td_1" width="100px">撰写作者</td>
			<td class="td_1">${problem.author}</td>
		</tr>
		<tr><td class="td_1">试题标题</td>
			<td class="td_1">
				<input type="text" style="width:450px;" name="problem.title" value="<s:property value='problem.title'/>"/>
				<s:fielderror cssClass="formFieldError"><s:param>problem.title</s:param></s:fielderror>
			</td>
		</tr>
		<tr><td class="td_1">试题来源</td>
			<td class="td_1">
				<input type="text" style="width:450px;" name="problem.source" value="<s:property value='problem.source'/>"/>
		...
		<tr><td class="td_1">试题顺序</td>
			<td class="td_1">
				<select name="problem.sequence">
					...
					<option value="10">problem G</option>
		...
		<tr><td>&nbsp;</td>
			<td class="td_1">
				...
				<input type="hidden" name="problem.author" value="${problem.author}"/>
