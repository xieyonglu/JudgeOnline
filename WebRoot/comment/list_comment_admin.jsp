...
<input type="hidden" name="actionURL" value="comment_pageComment.action?action=admin&type=problem"/>
    ...
    <tbody>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="20%" align=center class=txlrow>
	        	<a href="comment_findComment.action?problemId=${problemId}&action=admin">
	        		查看评论
	        	</a>
	        </td>
