...
<input type="hidden" name="actionURL" value="type_pageType.action?action=admin"/>
...
<form name="form1" method="post" action="">
  <table width="1052px" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">类型信息管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="20%" align="center" class=txlHeaderBackgroundAlternate>类型名</td>
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>试题个数</td>
        <td width="20%" align="center" class=txlHeaderBackgroundAlternate>创建日期</td>
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>查看试题</td>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
      		<td width="10%" align="center" class="txlrow">
      			<input type="checkbox" name="checkList" value="${typeId}">
      		</td>
	        <td width="10%" align=center class=txlrow>
	        ...
	        <td width="10%" align=center class=txlrow>
	        	<a href="problem_pageProblem.action?action=admin&typeId=${typeId}">查看试题</a>
	        </td>
	        <td width="20%" align=center class=txlrow>
	        	<img src="${pageContext.request.contextPath}/image/update.gif" width="16" height="16" />
					<a href="type_showType.action?typeId=${typeId}&action=update">编辑</a>&nbsp; &nbsp;
				<img src="${pageContext.request.contextPath}/image/delete.gif" width="16" height="16" />
					<a href="type_deleteType.action?typeId=${typeId}">删除</a>
	        </td>
	    </tr>
	  </s:iterator>
      ...
      <tr bgcolor="#DEE5FA">
        <td colspan="16" align=center bgcolor="#DEE5FA" class=txlrow>
        	<span class="tablebody2">
          	...
          	<input type="button" value="添加" class="but" onclick="window.location.href='${pageContext.request.contextPath}/type/insert_type.jsp'"/>
          	<input type="button" value="删除" class="but" onclick="batchDelete('type_batchDelete.action')"/>
        </td>
      </tr>
