...
<input type="hidden" name="actionURL" value="comment_pageComment.action?userId=${sessionScope.loginUser.userId}"/>
    ...
    <tbody>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="20%" align=center bgcolor="#DEE5FA" class=txlrow>
	        	<a href="comment_findComment.action?action=user&problemId=${problemId}&userId=${sessionScope.loginUser.userId}">
	        		查看评论
	        	</a>
	        </td>
