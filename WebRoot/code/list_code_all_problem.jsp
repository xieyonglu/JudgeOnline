...
$(function(){
	...
	var str="code_pageFindCode.action?conditionA="+conditionA+"&conditionB="+conditionB+
			...
			"&action=all&problemId="+${problem.problemId};
...
<input type="hidden" name="actionURL" value="code_pageCode.action?action=all&problemId=${problem.problemId}"/>
...
<form name="form1" method="post" action="">
  <table width="1000" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">
        	<span style="color:red;"><b>${problem.title}</b></span>所有运行结果
        </th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="8%" align="center" class=txlHeaderBackgroundAlternate>语言</td>
        <td width="8%" align="center" class=txlHeaderBackgroundAlternate>代码长度</td>
        <td width="16%" align="center" class=txlHeaderBackgroundAlternate>提交时间</td>
      </tr>
      ...
      <s:iterator value="#list" status="st">
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="8%" align=center class=txlrow>${language}</td>
	        <td width="6%" align=center class=txlrow>${codeLength}</td>
	        <td width="16%" align=center class=txlrow>
