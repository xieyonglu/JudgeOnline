...
<form name="form1" method="post" action="">
  <table width="1052" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">管理员信息管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>真实姓名</td>
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>性别</td>
        <td width="15%" align="center" class=txlHeaderBackgroundAlternate>创建日期</td>
        <td width="10%" align="center" class=txlHeaderBackgroundAlternate>权限</td>
      	...
      	<tr bgcolor="#DEE5FA">
	        ...
	        <td width="20%" align=center class=txlrow>
	        	<img src="${pageContext.request.contextPath}/image/update.gif" width="16" height="16" />
					<a href="admin_showAdmin.action?adminId=${adminId}&action=update">编辑</a>&nbsp; &nbsp;
				<img src="${pageContext.request.contextPath}/image/delete.gif" width="16" height="16" />
					<a href="admin_deleteAdmin.action?adminId=${adminId}">删除</a>
	        </td>
	    </tr>
	  </s:iterator>
      ...
      <tr bgcolor="#DEE5FA">
        <td colspan="16" align=center bgcolor="#DEE5FA" class=txlrow>
        	<span class="tablebody2">
          	...
          	<input type="button" value="添加" class="but" onclick="window.location.href='${pageContext.request.contextPath}/admin/insertAdmin.jsp'"/>
          	<input type="button" value="删除" class="but" onclick="batchDelete('admin_batchDelete.action')"/>
        </td>
      </tr>
      <tr bgcolor="#DEE5FA">
        <td colspan=16 align=center class=txlrow></td>
