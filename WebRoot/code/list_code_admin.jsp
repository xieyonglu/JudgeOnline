...
<form name="form1" method="post" action="">
  <table width="1600" border="0" align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">用户的所有运行结果信息</th>
      </tr>
      <tr bgcolor="#DEE5FA">
